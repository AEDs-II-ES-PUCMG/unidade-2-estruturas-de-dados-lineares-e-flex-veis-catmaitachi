...
public class Fila<E> {
    ...
    public Fila<E> extrairLote(int numItens) {
        ...
        if (numItens < 0) throw new IllegalArgumentException("O número de itens a extrair deve ser não negativo.");

        Fila<E> lote = new Fila<>();

        for (int i = 0; i < numItens; i++) {
            
            if (this.vazia()) throw new NoSuchElementException("Não há itens suficientes na fila para extrair o lote.");
